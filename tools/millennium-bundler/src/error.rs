...
#[non_exhaustive]
pub enum Error {
	/// Error running millennium_utils API.
	#[error("{0}")]
	Resource(#[from] millennium_utils::Error),
	/// Bundler error.
	#[error("{0}")]
	...
	ArchError(String),
	/// Couldn't find icons.
	#[error("Could not find icon paths. Please make sure they exist in the Millennium config file.")]
	IconPathError,
