...
use std::{char, collections::HashSet, ffi::OsString, mem::MaybeUninit, os::windows::ffi::OsStringExt, sync::MutexGuard};
			...
			for vk in 0..256 {
				...
				match vk {
					_ if vk == VK_CONTROL
						...
						|| vk == VK_SHIFT || vk == VK_LSHIFT
						|| vk == VK_RSHIFT || vk == VK_MENU
