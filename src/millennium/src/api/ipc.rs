...
/// * `success_callback` the function name of the Ok callback. Usually the
///   `resolve` of the JS Promise.
/// * `error_callback` the function name of the Err callback. Usually the
///   `reject` of the JS Promise.
///
